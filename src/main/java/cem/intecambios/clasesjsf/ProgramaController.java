...
public class ProgramaController implements Serializable {
    ...
    @EJB
    private cem.intecambios.controlador.ProgramaFacade ejbFacade;
    ...
    public Programa getPrograma(java.math.BigDecimal id) {
